...
def train_ensemble_binary_classifier(config_path: str, data_path: str):
    config = None
...
def test_epoch_ensemble_final_classification(valid_ds, criterion):
    ...
    animals_model_params = {"num_classes": 6}   # e.g., 6 animal classes
    vehicles_model_params = {"num_classes": 4}    # e.g., 4 vehicle classes
...
if __name__ == "__main__":
    args = get_arguments()
    train_ensemble_binary_classifier(args.config, args.data_path)
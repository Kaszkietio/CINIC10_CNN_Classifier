...
def get_cinic(
    ...
    cinic_train = get_dataset(train_path, batch_size, True, True, augmentations_train_EfficientNet)
    cinic_validation = get_dataset(valid_path, batch_size, True, True, augmentations_val_test_EfficientNet)
    cinic_test = get_dataset(test_path, batch_size, True, True, augmentations_val_test_EfficientNet)
